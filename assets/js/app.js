...
const CERTS=[
  ...
  {ico:"☁️",name:{en:"Introduction to AWS",pt:"Introdução à AWS"},by:"Rocketseat · 2026"},
  {ico:"⚡",name:{en:"FastAPI",pt:"FastAPI"},by:"Rocketseat · 2026"},
  {ico:"🧠",name:{en:"Prompt Engineering",pt:"Engenharia de Prompt"},by:"Rocketseat · 2026"},
  {ico:"🤖",name:{en:"Generative AI from Scratch",pt:"IA Generativa do Zero"},by:"Rocketseat · 2026"},
  {ico:"🔧",name:{en:"Git & GitHub",pt:"Git e GitHub"},by:"Rocketseat · 2026"},
  {ico:"🐍",name:{en:"Python",pt:"Python"},by:"Santander · 2026"}
];
...
function renderCerts(){
  document.getElementById("certs-grid").innerHTML=CERTS.map(c=>
    `<div class="cert sfx"><div class="ico">${c.ico}</div><div><h4>${esc(L(c.name))}</h4><div class="by">${esc(c.by)}</div></div></div>`).join("");
}
